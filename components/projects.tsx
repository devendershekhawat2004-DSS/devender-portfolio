          ...
          <div className="space-y-8">
            {projects.map((project, index) => (
              <div
                ...
                className="group relative p-8 bg-gradient-to-br from-slate-700/30 to-slate-800/30 rounded-xl border border-cyan-500/20 hover:border-cyan-400/60 overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/30"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/0 via-blue-500/0 to-cyan-500/0 group-hover:from-cyan-500/5 group-hover:via-blue-500/5 group-hover:to-cyan-500/5 transition-all duration-500" />

                <div className="relative z-10">
                  <h3 className="text-2xl font-bold text-white mb-2">{project.title}</h3>
                  <p className="text-gray-400 mb-4">{project.description}</p>

                  <p className="text-cyan-400 font-semibold mb-4">{project.impact}</p>
